...
public class ColorPicker_v4 extends GraphicsProgram {
	...
	public void run() {
		...
		/*
		String[] colors = new String[] {"000000", "00FF00", "FF0000", "0000FF"};
		String[] colorNames = new String[] {"Black", "Green", "Red", "Blue"};
		*/
		...
		while (true) {
			...
			//set colors
			String hexColor = colorsArrayFinal[0]; //change to colors[random] or colorsArrayFinal[0]
			String colorName = colorsArrayFinal[1]; //change to colorNames[random] or colorsArrayFinal[1]
			//hex for debugging
			println(hexColor);
